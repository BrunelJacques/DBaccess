...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        txt = "Ceci est un example<BR />...et la deuxième ligne ensuite"
        title = "ICI le titre"
        self.ctrl = Bandeau(panel, title,txt,nomImage="xpy/images/32x32/escadrille.jpg")
